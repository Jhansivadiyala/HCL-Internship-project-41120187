...
?>
    ...
    <h2 class="text-center"> Thank you for visiting Us! We wish you have a safe ride...Follow Traffic Rules :) </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                <h3 style="color: orange;">Your booking has been received and Being processing.</h3>
                <br>
                <h4>Please make a note of your <strong>order number</strong> now and communicate with us about your order.</h4>
                <br>
